...
async function performAutoSetup(event, p1Url, p2Url, context) {
    ...
    try {
        ...
        const inviteLink = await new Promise((resolve, reject) => { /* ... link extraction logic ... */
        ...
        const p2LoadPromise = new Promise((resolve, reject) => { /* ... P2 load logic ... */
        ...
        await new Promise((resolve, reject) => { /* ... wait for input logic ... */
        ...
        // *** NEW STEP: Tell renderer to collapse sidebar ***
        console.log('AutoSetup Step 16: Requesting sidebar collapse');
        ...
        try {
             ...
             if (mainWindow && currentViewNum !== 1 && view1 && !view1.webContents.isDestroyed()) { console.log("Switching back to V1 after error."); setCurrentView(1); mainWindow.setBrowserView(view1); resizeView(view1); }
