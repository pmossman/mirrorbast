...
contextBridge.exposeInMainWorld('api', {
  ...
  onPreview:        (cb)  => ipcRenderer.on('preview-updated', (_e,data)=>cb(data)),
  autoSetup:        (p1,p2) => ipcRenderer.send('auto-setup', p1, p2),
  onAutoSetupDone:  (cb)  => ipcRenderer.on('auto-setup-done', cb),
});
